...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/andreask/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86 -ltcl84'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LD:/Tcl/lib -ltcl84'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Tcl/include'
...
TCL_PACKAGE_PATH='D:/Tcl/lib D:/Tcl/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/andreask/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86 -ltclstub84'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Tcl/lib -ltclstub84'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/andreask/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86/tclstub84.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='D:/Tcl/lib/tclstub84.lib'
