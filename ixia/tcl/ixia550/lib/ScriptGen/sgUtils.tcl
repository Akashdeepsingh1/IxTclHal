...
#Protocol
    ...
    set enumList [list mac ipV4 ipx ipV6 pauseControl fcoe]
    setEnumValList $enumList enumValList
...
#Port
	...
	set enumList [list portOperationModeStream portOperationModeRtp portOperationModeTsoLro]
	setEnumValList $enumList enumValList
...
proc scriptGen::printCardInfo { chassId cardId portId {filePerPortFlag $::false} } \
{
	...
	if { $retCode == $::TCL_OK } {
		...
		if {[scriptGen::getCardScript   $chassId $cardId]} {
