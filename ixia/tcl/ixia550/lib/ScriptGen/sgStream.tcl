...
proc scriptGen::getFcoeInStream {chassis card port packet} \
{
    ...
    getProtocolInStream fibreChannel $chassis $card $port $packet 
...
proc scriptGen::getIcmpV6InStream { chassis card port } \
{
	...
	set cmd icmpV6Error
	set enumList [list icmpV6NoRouteToDestination icmpV6CommunicationProhibted icmpV6NotAssigned icmpV6AddressUnreachable icmpV6PortUnreachable ]
...
proc scriptGen::getDataCenterEncapsulationInStream { chassis card port } \
{
    ...
    if { [protocol cget -enableDataCenterEncapsulation] } {
		set dataCenterEncapsulationMainList			[list ethertypeDTag fTag ttl embeddedDa embeddedSa]
