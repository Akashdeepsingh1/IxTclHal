...
proc scriptGen::doIsisRouter {name} \
{
    ...
    if {![isisRouter getFirstDceInterestedVlanRange]} {
            set nameIndex 2
            doIsisDceInterestedVlanRange interestedVlanRange1
            while {![isisRouter  getNextDceInterestedVlanRange]} {
...
proc scriptGen::doIsisDceInterestedVlanRange {name} \
{
    ...
    sgPuts "isisRouter addDceInterestedVlanRange $name"
	sgPuts ""
    return $retCode
}
...
proc scriptGen::doIsisDceNetworkRange {name} \
{
    ...
    if {![isisDceNetworkRange getFirstDceNodeInterestedVlanRange]} {
            set nameIndex 2
            doIsisDceNodeInterestedVlanRange nodeInterestedVlanRange1
            while {![isisDceNetworkRange  getNextDceNodeInterestedVlanRange]} {
...
proc scriptGen::doIsisDceNodeInterestedVlanRange {name} \
{
    ...
    sgPuts "isisDceNetworkRange addDceNodeInterestedVlanRange $name"
	sgPuts ""
	return $retCode
}
